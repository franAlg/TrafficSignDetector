...
model = keras.models.load_model('models/gtsdb_rpn/gtsdb_rpn-1/gtsdb1-last.hdf5')

gen = ImageDataGenerator(rescale=1./255)
testgen = gen.flow_from_directory('../dataset/PNG_test', classes=None, target_size=(600,900), batch_size=1000, shuffle=True)
